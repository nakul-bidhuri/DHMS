    ...
    <nav className="sticky top-0 z-50 w-full border-b border-digitech-red/20 bg-[#020617]/90 backdrop-blur-md">
      ...
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="hidden md:block text-xs text-white hover:text-red-400 transition-colors">
            Login
          </button>
          <a href="#waitlist" className="bg-digitech-red hover:bg-red-400 text-[#020617] px-4 py-2 rounded-sm text-xs font-bold transition-colors shadow-[0_0_10px_rgba(229,57,53,0.2)]">
            DEMO_REQ
          </a>
        </div>
      </div>
    ...
    <section className="relative pt-24 pb-32 overflow-hidden bg-[#020617] bg-cyber-dots">
      ...
      <div className="container relative z-10 mx-auto px-4 flex flex-col items-center text-center">
        <div className="max-w-4xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-sm bg-digitech-red/10 border border-digitech-red/20 text-red-400 text-xs mb-8 shadow-[0_0_15px_rgba(229,57,53,0.2)]">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-white leading-tight mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-cyan-500er">Telemetry & Health.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="#waitlist" className="bg-digitech-red hover:bg-red-400 text-[#020617] px-8 py-4 rounded-sm font-bold flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(229,57,53,0.3)]">
              [ REQUEST_PLATFORM_DEMO ] <ArrowRight className="w-5 h-5" />
            </a>
            <a href="#waitlist" className="bg-white/5 hover:bg-white/10 text-white border border-white/10 px-8 py-4 rounded-sm flex items-center justify-center gap-2 transition-all">
    ...
    <section className="py-24 bg-[#020617] bg-tech-grid relative border-b border-white/10" id="product">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-white/5 border border-white/10 text-gray-400 text-[10px] mb-6">
            <Lock className="w-3 h-3 text-gray-500" /> [ SYSTEM_AUDIT ]
          </div>
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Your cameras are installed. <br/><span className="text-digitech-red">But are they working?</span></h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          {[
            ...
            <div key={i} className="bg-[#050914]/80 backdrop-blur-sm border border-red-500/20 p-6 rounded-sm text-left flex flex-col group hover:border-red-500/60 transition-colors relative overflow-hidden shadow-[0_0_20px_rgba(229,57,53,0.05)] hover:shadow-[0_0_30px_rgba(229,57,53,0.15)]">
              <div className="absolute top-0 right-0 p-2 text-[10px] text-red-500/50 group-hover:text-red-500 transition-colors">{item.id}</div>
              ...
              <h3 className="text-white text-sm mb-2">{item.title}</h3>
    ...
    <section className="py-24 bg-[#020617] bg-cyber-dots relative border-b border-white/5" id="features">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/10 pb-8">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[10px] mb-4">
              <Activity className="w-3 h-3" /> [ DIAGNOSTIC_COVERAGE ]
            </div>
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">What does Digitech HMS monitor?</h2>
            <p className="text-gray-400 text-lg">&gt; Complete visibility across every layer of your security infrastructure.</p>
          </div>
          <div className="text-right hidden md:block border border-white/10 bg-white/5 p-4 rounded-sm">
            <div className="text-[10px] text-gray-500 mb-1">SCAN_RATE</div>
            <div className="text-2xl text-blue-400 animate-pulse">1000/sec</div>
          </div>
        </div>
            ...
            <div key={i} className={`bg-[#050914]/80 backdrop-blur-xl border border-white/5 rounded-sm p-8 transition-all relative overflow-hidden group shadow-[0_0_15px_rgba(0,0,0,0.5)] ${module.borderColor}`}>
              ...
              <ul className="space-y-3">
                {module.items.map((item, j) => (
                  <li key={j} className="flex items-center gap-3 text-gray-500 group-hover:text-gray-300 text-sm transition-colors">
...
function HowItWorks() {
  ...
  return (
    <section className="py-24 bg-[#020617] bg-cyber-dots relative overflow-hidden" id="how-it-works">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-[10px] mb-6">
            <Lock className="w-3 h-3" /> [ WORKFLOW_PROTOCOL ]
          </div>
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Why Digitech HMS?</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {steps.map((step, i) => (
            <div key={i} className="relative p-6 bg-[#050914]/90 backdrop-blur-xl rounded-sm border border-white/5 text-center hover:border-indigo-500/50 hover:bg-indigo-500/5 transition-all group shadow-[0_0_15px_rgba(0,0,0,0.5)] hover:shadow-[0_0_20px_rgba(99,102,241,0.15)]">
              <div className="text-indigo-500/50 text-xs mb-3 group-hover:text-indigo-400 transition-colors">STEP_{step.num}</div>
              <h4 className="text-white text-sm mb-2">{step.title}</h4>
              <p className="text-xs text-gray-500 group-hover:text-gray-400 transition-colors">{step.desc}</p>
              {i < steps.length - 1 && (
    ...
    <section className="py-24 bg-[#050914] border-y border-white/10">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-white/5 border border-white/10 text-digitech-red text-[10px] mb-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-[#111827] border border-red-500/20 rounded-sm p-8 relative overflow-hidden">
            ...
            <h3 className="text-xl text-white mb-8 pb-4 border-b border-white/10 flex items-center gap-2">
    ...
    <section className="py-24 bg-[#020617] bg-tech-grid border-y border-white/10 overflow-hidden relative">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-white/5 border border-white/10 text-blue-400 text-[10px] mb-6">
              <MapPin className="w-3 h-3 text-blue-500" /> [ GEO_DISTRIBUTION ]
            </div>
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Multi-Site Monitoring</h2>
          ...
          <div className="relative p-8 lg:p-12">
            ...
            <div className="relative bg-[#050914]/90 backdrop-blur-md border border-blue-500/20 rounded-sm p-6 shadow-[0_0_30px_rgba(59,130,246,0.1)]">
              
              <div className="flex justify-between items-start mb-6 border-b border-white/10 pb-4">
                <div>
                  <div className="text-white font-bold">DIGITECH HMS</div>
                  <div className="text-blue-400 text-[10px] mt-1">GLOBAL.NOC.NODE</div>
                </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-center">
                ...
                <div className="bg-blue-500/5 border border-yellow-500/30 rounded-sm p-3 relative group hover:border-yellow-500/80 transition-colors cursor-default shadow-[0_0_10px_rgba(234,179,8,0.05)]">
                  ...
                  <div className="text-white text-sm mb-1">Gurugram</div>
...
function Industries() {
  ...
  return (
    <section className="py-24 bg-[#050914] bg-tech-grid relative border-b border-white/10" id="industries">
      <div className="container relative z-10 mx-auto px-4">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-white/5 border border-white/10 text-red-400 text-[10px] mb-6">
            <Building2 className="w-3 h-3 text-digitech-red" /> [ SECTOR_DEPLOYMENTS ]
          </div>
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">Built for critical security environments</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {industries.map((ind, i) => (
            <div key={i} className="flex items-start gap-4 p-6 bg-[#111827]/90 backdrop-blur-md border border-white/10 rounded-sm hover:border-digitech-red/30 transition-colors group">
              ...
              <div>
                <h3 className="text-sm text-white mb-1">{ind.name}</h3>
    ...
    <section className="py-24 bg-[#020617] bg-tech-grid relative overflow-hidden">
      <div className="container relative z-10 mx-auto px-4">
        <div className="bg-[#050914]/80 backdrop-blur-xl border border-digitech-red/30 rounded-sm p-8 md:p-12 shadow-[0_0_40px_rgba(229,57,53,0.05)]">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-red-500/10 border border-red-500/20 text-digitech-red text-[10px] mb-6">
                <Zap className="w-3 h-3 text-red-500" /> [ SERVICE_INTEGRATION ]
              </div>
              <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Turn your AMC into a measurable SLA</h2>
              <p className="text-gray-400 text-lg mb-8">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="bg-[#111827] border border-white/10 p-4 rounded-sm">
                  ...
                  <div className="text-[10px] text-gray-500">Guaranteed Uptime</div>
                </div>
                <div className="bg-[#111827] border border-white/10 p-4 rounded-sm">
                  <div className="text-3xl font-bold text-white mb-1">2.3h</div>
                  <div className="text-[10px] text-gray-500">Avg Resolution Time</div>
                </div>
              </div>
            </div>
            <div className="bg-[#020617] border border-white/10 rounded-sm p-6 relative">
              ...
              <div className="space-y-4 text-sm">
                ...
                <div className="pt-4 flex justify-between items-center">
                  <span className="text-white font-bold">AMC SLA</span>
                  <span className="bg-digitech-red/10 border border-digitech-red/20 text-red-400 px-3 py-1 rounded-sm text-[10px] font-bold">✓ COMPLIANT</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-[#111827] border border-white/10 rounded-sm p-8 mb-24 text-center max-w-4xl mx-auto relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-xl md:text-2xl font-bold text-white mb-4">Your video stays on your premises.</h3>
            <p className="text-gray-400 mb-8 max-w-2xl mx-auto text-sm">&gt; Digitech HMS monitors health and status — not your surveillance footage. Built for high-security environments.</p>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex flex-col items-center gap-2">
                <Video className="w-6 h-6 text-gray-500 line-through" />
                <span className="text-sm text-gray-400">No Video Streaming</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <Activity className="w-6 h-6 text-digitech-red" />
                <span className="text-sm text-gray-400">Status Data Only</span>
              </div>
              <div className="flex flex-col items-center gap-2">
                <ShieldCheck className="w-6 h-6 text-blue-500" />
                <span className="text-sm text-gray-400">Secure Communication</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-blue-500/10 border border-blue-500/20 text-blue-400 text-[10px] mb-6">
            ...
            <p className="text-gray-400 text-sm">&gt; The business value of continuous monitoring.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-[#111827] border border-red-500/20 rounded-sm p-6 relative">
              ...
              <h4 className="text-red-400 font-bold mb-6 flex items-center gap-2"><ArrowRight className="w-4 h-4 rotate-90" /> Decreases</h4>
            ...
            <div className="bg-[#111827] border border-emerald-500/20 rounded-sm p-6 relative shadow-[0_0_20px_rgba(16,185,129,0.05)]">
              ...
              <h4 className="text-emerald-400 font-bold mb-6 flex items-center gap-2"><ArrowRight className="w-4 h-4 -rotate-90" /> Increases</h4>
              <div className="space-y-2">
    ...
    <section id="waitlist" className="py-24 bg-[#050914] border-t border-white/5 relative overflow-hidden bg-tech-grid">
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded bg-digitech-red/10 border border-digitech-red/20 text-red-400 text-[10px] mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <form className="md:col-span-2 space-y-6" id="wl-form" noValidate>
              <div className="grid md:grid-cols-2 gap-6 text-sm">
                <div>
                  <label htmlFor="wl-name" className="block text-gray-400 mb-2">Your name *</label>
                ...
                <div>
                  <label htmlFor="wl-phone" className="block text-gray-400 mb-2">Phone number *</label>
              ...
              <div className="text-sm">
                <label htmlFor="wl-org" className="block text-gray-400 mb-2">Business or organisation *</label>
              ...
              <div className="grid md:grid-cols-2 gap-6 text-sm">
                <div>
                  <label htmlFor="wl-city" className="block text-gray-400 mb-2">City</label>
                ...
                <div>
                  <label htmlFor="wl-email" className="block text-gray-400 mb-2">Email (optional)</label>
              ...
              <div className="grid md:grid-cols-2 gap-6 text-sm">
                <div>
                  <label htmlFor="wl-sites" className="block text-gray-400 mb-2">Number of locations</label>
                ...
                <div>
                  <label htmlFor="wl-plan" className="block text-gray-400 mb-2">Which plan interests you</label>
              ...
              <div className="text-sm">
                <label htmlFor="wl-message" className="block text-gray-400 mb-2">Anything you would like us to know</label>
              ...
              <button className="bg-digitech-red hover:bg-red-400 text-[#050B14] px-8 py-4 rounded-sm font-bold transition-colors mt-4 w-full md:w-auto" type="submit" id="wl-submit">
                [ SUBMIT_REQUEST ]
              </button>
            ...
            <aside className="md:pl-8 border-l border-white/5 space-y-8">
              ...
              <div>
                <p className="text-sm text-gray-500 mb-2">Or simply call us</p>
